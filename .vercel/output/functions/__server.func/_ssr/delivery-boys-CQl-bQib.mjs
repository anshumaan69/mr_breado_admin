...
import { j as useDrivers, k as useVerifyDriverDeposit, P as PageHeader, S as StatusBadge, l as driverKeys, n as driversService } from "./router-CKeaDZpC.mjs";
import { u as useTableSearch, S as ServerTable } from "./server-table-C3wGZ1Ak.mjs";
import { d as Bike, V as Eye, m as CreditCard, a1 as CircleCheck, X, w as LoaderCircle, o as ShieldCheck } from "../_libs/lucide-react.mjs";
...
function DriverModal({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-3xl rounded-2xl border border-border bg-card p-5 shadow-2xl", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 border-t border-border pt-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-sm font-bold mb-3 flex items-center gap-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Bike, { className: "h-4 w-4 text-primary" }),
        " Assigned Orders (",
        details?.orders?.length ?? 0,
        ")"
      ] }),
      isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center py-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-6 w-6 animate-spin text-primary" }) }) : !details?.orders || details.orders.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground text-center py-6 border border-dashed border-border rounded-xl", children: "No active or past orders assigned to this rider." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-h-48 overflow-y-auto rounded-xl border border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left text-xs", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-background text-muted-foreground uppercase font-bold sticky top-0 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "p-2.5", children: "Order #" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "p-2.5", children: "Customer" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "p-2.5", children: "Restaurant" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "p-2.5", children: "Amount" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "p-2.5", children: "Status" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/60", children: details.orders.map((order) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-accent/40", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-2.5 font-mono font-bold text-primary", children: order.orderNumber || `#${order.id}` }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-2.5", children: order.customerName || "—" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-2.5", children: order.outletName || "—" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "p-2.5 font-semibold", children: [
            "₹",
            Number(order.total || 0).toFixed(2)
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-2.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(StatusBadge, { status: order.status }) })
        ] }, order.id)) })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 flex flex-wrap justify-end gap-2 border-t border-border pt-4", children: [
