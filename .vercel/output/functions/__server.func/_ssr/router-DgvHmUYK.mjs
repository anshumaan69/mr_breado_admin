...
import "zlib";
const appCss = "/assets/styles-DxCILHWG.css";
...
const API_BASE_URL = "https://3chlkw5t-3000.inc1.devtunnels.ms/api"?.replace(/\/$/, "") || DEFAULT_API_BASE_URL;
...
const $$splitComponentImporter$A = () => import("./zones-f2fpMIfG.mjs");
...
const $$splitComponentImporter$z = () => import("./tickets-CiUZltIo.mjs");
...
const $$splitComponentImporter$y = () => import("./support-DAx7uEnl.mjs");
...
const $$splitComponentImporter$x = () => import("./subscriptions-CAJXllFu.mjs");
...
const $$splitComponentImporter$w = () => import("./settings-BgvGmF1A.mjs");
...
const $$splitComponentImporter$v = () => import("./service-area-verifications-C_HTF7Iq.mjs");
...
const $$splitComponentImporter$u = () => import("./roles-DEp0-2qX.mjs");
...
const $$splitComponentImporter$t = () => import("./reviews-DADU5sph.mjs");
...
const $$splitComponentImporter$s = () => import("./restaurants-Da_fivmw.mjs");
...
const $$splitComponentImporter$q = () => import("./permissions-MHJztiLJ.mjs");
...
const $$splitComponentImporter$p = () => import("./payouts-d2-bG2lf.mjs");
...
const $$splitComponentImporter$o = () => import("./owners-BvypmsHV.mjs");
...
const $$splitComponentImporter$n = () => import("./operations-BVfrVANm.mjs");
...
const $$splitComponentImporter$m = () => import("./offers-BZNEKXPX.mjs");
...
const $$splitComponentImporter$l = () => import("./notifications-DDHOTx6b.mjs");
...
const $$splitComponentImporter$k = () => import("./mr-breado-restaurant-CU3efPHl.mjs");
...
const $$splitComponentImporter$j = () => import("./login-BJRT4jHY.mjs");
...
const $$splitComponentImporter$i = () => import("./foods-pvUyj0aM.mjs");
...
function FoodsPage({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: isLoading ? Array.from({
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "rounded p-1.5 text-primary hover:bg-primary/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Pencil, { className: "h-4 w-4", onClick: () => {
              setEditing(p);
              setShowForm(true);
            } }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ModalForm, { open: showForm, onClose: () => {
      setShowForm(false);
      setEditing(null);
    }, form, setForm, editing, onSave: async () => {
      const fd = new FormData();
...
function ModalForm({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center overflow-y-auto bg-black/40 p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-4xl rounded-xl border border-border bg-card p-5 shadow-card", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mb-4 text-lg font-semibold", children: editing ? "Edit Food" : "Add Item" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-3 md:grid-cols-2 xl:grid-cols-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Title", value: form.title, onChange: (v) => set("title", v) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Subtitle", value: form.subtitle, onChange: (v) => set("subtitle", v) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Category", value: form.categoryName, onChange: (v) => set("categoryName", v) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Food Type", value: form.foodType, onChange: (v) => set("foodType", v) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Price", value: form.price, onChange: (v) => set("price", v) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Discount Price", value: form.discountPrice, onChange: (v) => set("discountPrice", v) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Stock Quantity", value: form.stockQuantity, onChange: (v) => set("stockQuantity", v) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Small Size Extra", value: form.smallSizeExtra, onChange: (v) => set("smallSizeExtra", v) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Medium Size Extra", value: form.mediumSizeExtra, onChange: (v) => set("mediumSizeExtra", v) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Large Size Extra", value: form.largeSizeExtra, onChange: (v) => set("largeSizeExtra", v) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Cake 500gm Extra", value: form.cake500gmExtra, onChange: (v) => set("cake500gmExtra", v) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Cake 1kg Extra", value: form.cake1kgExtra, onChange: (v) => set("cake1kgExtra", v) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Cake 1.5kg Extra", value: form.cake15kgExtra, onChange: (v) => set("cake15kgExtra", v) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Cake 2kg Extra", value: form.cake2kgExtra, onChange: (v) => set("cake2kgExtra", v) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Cake Message Charge", value: form.cakeMessageCharge, onChange: (v) => set("cakeMessageCharge", v) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "block text-sm font-medium", children: [
        "Image",
        /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "file", accept: "image/*", onChange: (e) => set("image", e.target.files?.[0] ?? null), className: "mt-1 w-full rounded-md border border-input px-3 py-2" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "mt-3 block text-sm font-medium", children: [
      "Description",
      /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", { value: form.description, onChange: (e) => set("description", e.target.value), className: "mt-1 min-h-24 w-full rounded-md border border-input px-3 py-2" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 grid gap-2 md:grid-cols-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Toggle, { label: "Veg", value: form.isVeg, onChange: (v) => set("isVeg", v) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Toggle, { label: "Available", value: form.isAvailable, onChange: (v) => set("isAvailable", v) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Toggle, { label: "Bestseller", value: form.isBestseller, onChange: (v) => set("isBestseller", v) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Toggle, { label: "Cake Message", value: form.cakeMessageEnabled, onChange: (v) => set("cakeMessageEnabled", v) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Toggle, { label: "Custom Weight", value: form.customWeightEnabled, onChange: (v) => set("customWeightEnabled", v) })
    ] }),
...
function Field({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "block text-sm font-medium", children: [
    label,
    /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: value ?? "", onChange: (e) => onChange(e.target.value), className: "mt-1 w-full rounded-md border border-input bg-background px-3 py-2" })
  ] });
}
function Toggle({
  label,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center justify-between rounded-lg border border-border p-3 text-sm font-medium", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "checkbox", checked: !!value, onChange: (e) => onChange(e.target.checked) })
  ] });
}
const $$splitComponentImporter$h = () => import("./delivery-boys-DPMCw5f0.mjs");
...
const $$splitComponentImporter$g = () => import("./customers-DUeX1O7K.mjs");
...
const $$splitComponentImporter$f = () => import("./customer-messages-BibTpu-K.mjs");
...
const $$splitComponentImporter$e = () => import("./cuisine-DioU94Zr.mjs");
...
const $$splitComponentImporter$d = () => import("./coupons-unQRfi8S.mjs");
...
const $$splitComponentImporter$c = () => import("./categories-D6Sqiws2.mjs");
...
const $$splitComponentImporter$b = () => import("./banners-DsqoORG1.mjs");
...
const $$splitComponentImporter$a = () => import("./admin-profile-Beae4mI8.mjs");
...
const $$splitComponentImporter$9 = () => import("./admin-foods-CvukInrI.mjs");
const Route$9 = createFileRoute("/admin-foods")({
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./index-ntKGQG8i.mjs");
...
const $$splitComponentImporter$7 = () => import("./index-CweSfPRh.mjs");
...
const $$splitComponentImporter$6 = () => import("./ready-for-pickup-B-qr7Qce.mjs");
const Route$6 = createFileRoute("/orders/ready-for-pickup")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./preparing-DNmhgLsq.mjs");
const Route$5 = createFileRoute("/orders/preparing")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./pending-CK5_uJAZ.mjs");
const Route$4 = createFileRoute("/orders/pending")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./delivered-CtVzwowt.mjs");
const Route$3 = createFileRoute("/orders/delivered")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./cancelled-jTTQ8Nj9.mjs");
const Route$2 = createFileRoute("/orders/cancelled")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./active-DyZwWsiv.mjs");
...
const $$splitComponentImporter = () => import("./accepted-10h_oO1Q.mjs");
